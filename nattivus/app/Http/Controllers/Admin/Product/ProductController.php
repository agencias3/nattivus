...
use AgenciaS3\Http\Controllers\Admin\Blog\PostProductController;
...
class ProductController extends Controller
{
    ...
    public function index(AdminRequest $request)
    {
        ...
        return view('admin.product.product.index', compact('dados', 'config'));
    }
    ...
    public function create()
    {
        ...
        $categories = $this->categoryRepository->orderBy('name')->all();

        return view('admin.product.product.create', compact('config', 'categories'));
    }
    ...
    public function store(AdminRequest $request)
    {
        try {
            ...
            return redirect()->route('admin.product.product.gallery.index', ['id' => $dados->id])->with('success', $response['success']);
    ...
    public function edit($id)
    {
        ...
        return view('admin.product.product.edit', compact('dados', 'config', 'categories'));
    }
