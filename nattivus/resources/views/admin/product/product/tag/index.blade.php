...
@section('content')
    <section role="main" class="content-body">
        ...
        <section class="panel">
            ...
            {!! Form::open(['route'=>'admin.product.product.tags.store', 'files'=> true]) !!}
                <div class="panel-body">
                    ...
                    @include('admin.product.product.tag._form')
                    ...
                    @foreach($dados as $row)
                        <tr>
                            ...
                            <td data-title="Ação" class="actions text-center">
                                <a href="#modalDestroy" data-route="{{ route('admin.product.product.tags.destroy', ['id' => $row->id]) }}" class="excluir remove-row btn btn-danger white" title="Excluir">
