...
@section('content')
    <section role="main" class="content-body">
        ...
        <section class="panel">
            ...
            {!! Form::open(['route'=>'admin.product.product.related.store', 'files'=> true]) !!}
                <div class="panel-body">
                    ...
                    @include('admin.product.product.related._form')
            ...
            <div class="panel-body">
                <table class="table table-no-more table-bordered table-striped mb-0">
                    ...
                    @foreach($dados as $row)
                        <tr>
                            <td data-title="Produto">{{ $row->productRelated->name }}</td>
                            <td data-title="Ação" class="actions text-center">
                                <a href="#modalDestroy" data-route="{{ route('admin.product.product.related.destroy', ['id' => $row->id]) }}" class="excluir remove-row btn btn-danger white" title="Excluir">
