    ...
    Route::group(['prefix' => 'blog', 'as' => 'blog.', 'namespace' => 'Blog'], function () {
        ...
        Route::group(['prefix' => 'post', 'as' => 'post.'], function () {
            ...
            Route::group(['prefix' => 'products', 'as' => 'products.'], function () {
                Route::get('{id}', ['as' => 'index', 'uses' => 'PostProductController@index']);
                Route::post('store', ['as' => 'store', 'uses' => 'PostProductController@store']);
                Route::get('destroy/{id}', ['as' => 'destroy', 'uses' => 'PostProductController@destroy']);
            });
